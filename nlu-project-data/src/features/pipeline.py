try:
    ...
    from heuristic_features import convert_to_lower, measure_sentiment, normalized_modifier_cnt, \
...
def main():
    clean_text = TextCleaner(text_cleaner=clean, replace_text=False, save_original=True)
